...
namespace GarageServiceApp.Controllers
{
    public class ServiceReceivedsController : Controller
    {
        ...
        public async Task<IActionResult> Create([FromForm] ServiceReceived serviceReceived)
        {
            ...
            ViewData["CustomerId"] = new SelectList(_context.Customer, "CustomerId", "Name", serviceReceived.CustomerId);
            return View(serviceReceived);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CustomerId,CarModel,LicensePlate,VIN,StateBeforeRepair,CustomerComplaint,Status,EstimatedCost,ReceivedDate,Notes")] ServiceReceived serviceReceived)
        {
