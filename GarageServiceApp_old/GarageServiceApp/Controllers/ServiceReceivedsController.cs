...
namespace GarageServiceApp.Controllers
{
    public class ServiceReceivedsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CustomerId,ServiceNumber,CarMake,CarModel,CarYear,LicensePlate,VIN,StateBeforeRepair,CustomerComplaint,InitialDiagnosis,Status,EstimatedCost,ActualCost,ReceivedDate,CompletedDate,DeliveredDate,Notes,TechnicianName")] ServiceReceived serviceReceived)
        {
            ...
            ViewData["CustomerId"] = new SelectList(_context.Customer, "Id", "FirstName", serviceReceived.CustomerId);
            return View(serviceReceived);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CustomerId,ServiceNumber,CarMake,CarModel,CarYear,LicensePlate,VIN,StateBeforeRepair,CustomerComplaint,InitialDiagnosis,Status,EstimatedCost,ActualCost,ReceivedDate,CompletedDate,DeliveredDate,Notes,TechnicianName")] ServiceReceived serviceReceived)
        {
